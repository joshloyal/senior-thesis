...
\def\average#1{\ensuremath{\langle#1\rangle}}
\def\Nzg#1{\ensuremath{N_{#1}^{Z\gamma}}}
\def\Nzj#1{\ensuremath{N_{#1}^{Z\text{jets}}}}
\def\Nzjmc#1{\ensuremath{N_{#1}^{Z\text{jetsMC}}}}
\def\New#1{\ensuremath{N_{#1}^{\text{EW$_{\text{bkg}}$}}}}
...
\newcommand\qmu{\ensuremath{\tilde q_{\mu}}\ }
